                    ...
                    <div className='subpostdiv'>
                        ...
                        <form className='PostTweets' onSubmit={handleSubmit}>
                            <div className='postinput'>
                                <textarea autoComplete='on' value={formData.description} onChange={handleChange}  name='description'  placeholder="Quoi de neuf" rows="7" type="description"/>
                            </div>
                            { isAlertVisible && <div className='valid'>
                                { valid && <p className="valid-message">{valid}</p>}
                            </div>}
                            <div className='postbutton'>
                                <button onClick={validMessageClick} type="submit">Poster</button>
                            </div>
                        </form>
                    </div>
                </div>
